...
const chairsWithNoArmrest: TailoredProduct[] = [
  {
    product: {
      ...
      description: [
        { token: "chair", sentiment: 0 },
        { token: "ivory", sentiment: 0 },
        { token: "1970s", sentiment: 0 },
        { token: "foampunk", sentiment: 0 },
  ...
  },
  {
    product: {
      ...
      description: [
        { token: "curved", sentiment: 0 },
        { token: "leather", sentiment: 0 },
        { token: "rounded", sentiment: 0 },
        { token: "chair", sentiment: 0 },
        { token: "white", sentiment: 0 },
        { token: "cushioning", sentiment: 0 },
        { token: "whimsical", sentiment: 0 },
        { token: "mushroom", sentiment: 0 },
        { token: "pop", sentiment: 0 },
        { token: "art deco", sentiment: 0 },
        { token: "soft edged", sentiment: 0 },
      ],
    },
  },
  {
    product: {
      ...
      description: [
        ...
        { token: "cute", sentiment: 0 },
        { token: "dreamy", sentiment: 0 },
        { token: "sfumato", sentiment: 0 },
        { token: "ivory", sentiment: 0 },
        { token: "creased", sentiment: 0 },
        { token: "deco", sentiment: 0 },
        { token: "pop", sentiment: 0 },
        { token: "tondo", sentiment: 0 },
        { token: "bulbous", sentiment: 0 },
      ],
    },
  },
  {
    product: {
      ...
      description: [
        ...
        { token: "arc", sentiment: 0 },
        { token: "lounge", sentiment: 0 },
        { token: "chair", sentiment: 0 },
        { token: "upholstered", sentiment: 0 },
        { token: "bold", sentiment: 0 },
        { token: "cartoonish", sentiment: 0 },
        { token: "lines", sentiment: 0 },
        { token: "velvety", sentiment: 0 },
        { token: "spiral", sentiment: 0 },
        { token: "extruded", sentiment: 0 },
        { token: "soft", sentiment: 0 },
        { token: "dreamy", sentiment: 0 },
      ],
    },
  },
  {
    product: {
      ...
      description: [{ token: "TODO", sentiment: -1 }],
    },
  },
  {
    product: {
